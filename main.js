...
function loadIntroText() {
  ...
  loader.load('fonts/unione.json', function (font) {
    ...
    const titleGeo = new TextGeometry('ANDIKA KURNIA SANDI YUDA', {
      font: font,
      size: 0.05,
      height: 0.01,
    });
  ...
  loader.load('fonts/helvatica.json', function (font) {
    ...
    const subTitleGeo = new TextGeometry(
      'UI/UX Designer / Web Developer / Android Developer',
      {
        font: font,
        size: 0.018,
        height: 0,
